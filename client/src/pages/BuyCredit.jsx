...
const BuyCredit = () => {
  ...
  return (
    <div className='min-h-[70vh] text-center pt-14 mb-10 ' >
      <button className='border border-gray-400 py-2 px-10 rounded-full mb-6'>Our Plans</button>
      ...
      <div className='flex flex-wrap justify-center gap-6 text-left'>
        {plans.map((plan, index) => (
          <div className='bg-white drop-shadow-sm border border-gray-300 rounded-lg py-12 px-8 text-gray-700 hover:scale-105 transition-all duration-500'>
            ...
            <button onClick={()=>paymentRazorPay(plan.id)} className='cursor-pointer w-full bg-gray-800 text-white mt-8 text-sm rounded-md py-2.5 min-w-52'>Purchase</button>
          </div>
        ))}
      </div>
    </div>
